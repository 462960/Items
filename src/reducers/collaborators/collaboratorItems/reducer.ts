...
export const GET_ITEMS = 'collaboratorItems/GET_ITEMS';
export const [GET_ITEMS_SUCCESS, GET_ITEMS_FAILURE] = [
  `${GET_ITEMS}_SUCCESS`,
  `${GET_ITEMS}_FAILURE`,
];

export const GET_COLUMNS = 'collaboratorItems/GET_COLUMNS';
export const [GET_COLUMNS_SUCCESS, GET_COLUMNS_FAILURE] = [
  `${GET_COLUMNS}_SUCCESS`,
  `${GET_COLUMNS}_FAILURE`,
];

export const UPDATE_COLUMNS = 'collaboratorItems/UPDATE_COLUMNS';
...
export default handleActions(
  {
    ...
    [UPDATE_COLUMNS]: (state, action: IAction) => {
      return state.setIn(
    ...
    [GET_COLUMNS_SUCCESS]: (state, action: IAction) => {
